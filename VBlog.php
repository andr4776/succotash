...
<html lang="en">
    ...
    <head>
        ...
        <title>SuccotashLenta VBlog</title>
  ...
  <body>
    ...
    <nav class="navbar navbar-inverse" role="navigation">
      <div class="container">
        <div class="navbar-header wow fadeIn">
          ...
          <a class="navbar-brand" href="index.html">Succotash blog page</a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="top-navbar-1">
          ...
          <ul class="nav navbar-nav navbar-right navbar-menu-items wow fadeIn">
            ...
            <li><a href="VBlog.php" class="active">VBlog</a></li>
    ...
    <div class="top-content">
      ...
      <div class="row column text-center">
        ...
        <h1>V-Blog</h1>
        <h2 class="subheader">Succotash<strong>Lenta</strong> Blog</h2>
      </div>
    ...
    <div class="row medium-8 large-7 columns">
      <div class="blog-post">
        <h3>Lenta Preview  <small>5/03/2017</small></h3>
        <video width="850" height="350" controls>
          <source class="thumbnail"src="assets/mp4/lenta_start.mp4" type="video/mp4">
        ...
        <div class="callout">
          <ul class="menu simple">
            <li><a href="#">author: Andre Roman</a></li>
      ...
      <div class="blog-post">
        <h3>v-blog post title <small>5/03/2017</small></h3>
