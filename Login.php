...
<html lang="en">
    ...
    <head>
        ...
        <title>SuccotashLenta Login Form</title>
      ...
      <nav class="navbar navbar-inverse" role="navigation">
  			<div class="container">
  				<div class="navbar-header wow fadeIn">
  					...
  					<a class="navbar-brand" href="index.html">Succotash login page</a>
  				</div>
            ...
            <div class="inner-bg">
                    ...
                    <div class="row">
                        <div class="col-sm-8 col-sm-offset-2 text">
                            <h1>Succotash<strong>Lenta</strong> Login Form</h1>
                        ...
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                        	<div class="form-top">
                        		<div class="form-top-left">
                        			<h3>Login to SuccotashLenta Archive</h3>
